...
def equalize_color(img1, img2):
    ...
    # Compute mean and standard deviation of L, a, and b channels of img1
    mean1, std1 = cv2.meanStdDev(lab1)
    mean1 = mean1.ravel()
    std1 = std1.ravel()

    # Normalize img2 channels by the mean and standard deviation of img1
...
def main():
    ...
    query_img = cv2.imread('./data/machado_1_3-20.jpg')
    train_img = cv2.imread('./data/machado_1_8-22.png')

    train_img = equalize_color(query_img, train_img)
